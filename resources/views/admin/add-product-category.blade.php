                            ...
                            <!-- General Data Content -->
                                    <!--  -->
                                     <div class="form-horizontal form-bordered">
                                        ...
                                        {{ Form::open(array('url' => '/admin/add-product-category', 'method' => 'post','files' => true)) }}

                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="category-name">Name</label>
                                            <div class="col-md-9">
                                             {{ Form::text('cat_name', '',$attributes = array('placeholder'=>'Enter Category name..','class'=>"form-control",'id'=>"category-name") ) }} 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <label class="switch switch-primary">
                                                     {{ Form::checkbox('status', '1',$attributes = array('class'=>"form-control",'id'=>"category-status",'checked'=>"checked") ) }}
                                                    <span></span>
                                                </label>
                                            </div>
                                        </div>
