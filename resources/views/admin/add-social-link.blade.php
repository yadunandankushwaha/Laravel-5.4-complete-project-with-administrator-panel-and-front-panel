			                ...
			                @endif
                                ...
                                <div class="block">
                                    ...
                                    <!-- Form Validation Example Content -->
                                     {{ Form::open(array('url' => '/admin/add-social-link', 'method' => 'post', 'id' => 'form-validation', 'class' => 'form-horizontal form-bordered', 'files' => true)) }}
                                    ...
                                    <!-- <form id="form-validation" action="page_forms_validation.html" method="post" class="form-horizontal form-bordered"> -->
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <div class="input-group">
                                        			 ...
                                        			 {{ Form::text('name', '',$attributes = array('placeholder'=>'Please type Social Link Name..','class'=>"form-control",'id'=>"name") ) }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="input-group">
                                                     {{ Form::url('link', '',$attributes = array('placeholder'=>'Please write  Social Link URL','class'=>"form-control") ) }}
                                                     <span class="input-group-addon"></span>
                                                    </div>
                                                     <p>
