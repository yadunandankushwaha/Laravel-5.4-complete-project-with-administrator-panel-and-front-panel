                            ...
                            @endif
                                ...
                                <div class="block">
                                    ...
                                    <!-- Form Validation Example Content -->
                                     {{ Form::open(array('url' => '/admin/update-team-data', 'method' => 'post', 'id' => 'form-validation', 'class' => 'form-horizontal form-bordered', 'files' => true)) }}

                                     <input type="hidden" name="id" value="{{ $data->id }}">

                                    <!-- <form id="form-validation" action="page_forms_validation.html" method="post" class="form-horizontal form-bordered"> -->
                                        <fieldset>
                                            <legend><i class="fa fa-angle-right"></i> Team Info</legend>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="title">Team Name <span class="text-danger">*</span></label>
                                                <div class="col-md-10">
                                                
                                                    <div class="input-group">
                                                    
                                                     {{ Form::text('name', $data->name ,$attributes = array('placeholder'=>'Your Title..','class'=>"form-control",'id'=>"title") ) }}
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <div class="input-group">
                                                     ...
                                                     {{ Form::text('designation', $data->designation ,$attributes = array('placeholder'=>'Team Designation..','class'=>"form-control",'id'=>"designation") ) }}
                                                    <span class="input-group-addon"></span>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <img src="/assets/img/teams/{{$data->image}}" alt="No Image" class="" width="50px">
                                                    </div>
                                                    <p>
