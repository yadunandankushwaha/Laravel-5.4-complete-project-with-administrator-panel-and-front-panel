                ...
                <!-- Page content -->
                    <div id="page-content">
                        ...
                        <ul class="breadcrumb breadcrumb-top">
                            <li>Testimonials</li>
                            <li><a href="">Update Testimonials</a></li>
                        </ul>
                            ...
                            @endif
                                ...
                                <div class="block">
                                    ...
                                    <!-- Form Validation Example Content -->
                                     {{ Form::open(array('url' => '/admin/update-testimonial-data', 'method' => 'post', 'id' => 'form-validation', 'class' => 'form-horizontal form-bordered', 'files' => true)) }}
                                    ...
                                    <!-- <form id="form-validation" action="page_forms_validation.html" method="post" class="form-horizontal form-bordered"> -->
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <img src="/assets/img/testimonials/{{$data->image}}" alt="No Image" class="" width="50px">
                                                    </div>
                                                    <p>
