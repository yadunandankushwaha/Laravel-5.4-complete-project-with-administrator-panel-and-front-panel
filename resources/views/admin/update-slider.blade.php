                            ...
                            @endif
                                ...
                                <div class="block">
                                    ...
                                    <!-- Form Validation Example Content -->
                                     {{ Form::open(array('url' => '/admin/update-slider', 'method' => 'post', 'id' => 'form-validation', 'class' => 'form-horizontal form-bordered', 'files' => true)) }}

                                    <!-- <form id="form-validation" action="page_forms_validation.html" method="post" class="form-horizontal form-bordered"> -->
                                    {{ Form::hidden('id', $data->id ,$attributes = array('id'=>"title") ) }}
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="input-group">
                                                    <textarea name="description" placeholder="Slider Description..." style="width: 700px;">{{ $data->description }}</textarea>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="val_password">Slider Current Image <span class="text-danger">*</span></label>
                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <img src="/assets/img/sliders/{{$data->image}}" alt="No Image" class="" width="50px">
                                                    </div>
                                                    <p>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="input-group">
                                                        <input type="checkbox" value="1" id="status" name="status" class="form-control" @if($data->status == 1) checked  @endif>
